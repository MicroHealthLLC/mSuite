...
class Mindmap < ApplicationRecord
  ...
  enum mm_type: { simple: 0, kanban: 1, tree_map: 2, tree_chart: 3, whiteboard: 4, flowmap: 5, todo: 6, Notepad: 7, spreadsheet: 8, calendar: 9, poll: 10, pollvote: 11, venndiagram: 12, powerpoint: 13}
